...
const $$file$1 = "/Users/nic.motta/Code/muru-web-dev/src/pages/index.astro";
const $$url$1 = "";
...
const $$Live = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Live;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Respir0 Namiki" }, { "default": ($$result2) => renderTemplate`${renderComponent($$result2, "ContainerLive", null, { "client:only": "svelte", "client:component-hydration": "only", "client:component-path": "/Users/nic.motta/Code/muru-web-dev/src/components/SvelteComponents/ContainerLive/ContainerLive.svelte", "client:component-export": "default" })}` })}
<!-- <Pecinco client:only/> -->`;
}, "/Users/nic.motta/Code/muru-web-dev/src/pages/live.astro");

const $$file = "/Users/nic.motta/Code/muru-web-dev/src/pages/live.astro";
const $$url = "/live";
