<script>
  ...
  import { isLoading, count, dataInfo } from "../../context/store.ts";
  import { COLORS } from "../../constants";
  export let colorValue;

  const AMBIENT_COLOR = 50;
  const SPECULAR_COLOR = 70;
  let MODELS_IMG;
  let sizeModel = 26;
  ...
  const sketch = (p5) => {
    ...
    p5.draw = () => {
      ...
      if (!isMobile) {
        ...
        p5.ambientLight(AMBIENT_COLOR);
        p5.specularMaterial(SPECULAR_COLOR);
      ...
      if (isMobile) {
        ...
        p5.image(
          MODELS_IMG[dataInfo[$count].name][imgColor],
          imgMovement.x,
          imgMovement.y,
          1920 * 1.25,
          1080 * 1.25
    ...
    p5.preload = () => {
      ...
      MODELS_IMG = {
        ...
        ACHIRA: {
          ...
          limeGreen: p5.loadImage(
            "../assets/images/achira-front-limeGreen.png"
          ),
        ...
        SEMILLAS: {
          ...
          limeGreen: p5.loadImage(
            "../assets/images/semillas-front-limeGreen.png"
          ),
        ...
        TORTUGA: {
          ...
          limeGreen: p5.loadImage(
            "../assets/images/tortuga-front-limeGreen.png"
          ),
